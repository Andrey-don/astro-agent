...
7. **Фокусное слово** — ОДНО слово, которое ОБЯЗАТЕЛЬНО есть в заголовке статьи (пункт 1). Например, если заголовок «Физика чёрной дыры» — фокусное слово «Физика» или «дыры». Именно одно слово из заголовка — тогда Yoast SEO даёт зелёный индикатор
