...
7. **Фокусное слово** — ОДНО слово (не фраза!), главное ключевое слово статьи. Именно одно слово — тогда Yoast SEO даёт зелёный индикатор
8. **Ключевые слова** — 5-7 слов/фраз из текста (дополнительные)
9. **Slug** (URL) — латиницей, через дефис, без стоп-слов
10. **Замечания** — что исправить для лучшего SEO"""
